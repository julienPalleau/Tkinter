...
input_frame.grid_propagate(0)  # It means that the frame will no longer resize to the widget it contains in.
...
count_button.grid(row=1, column=0, padx=5, columnspan=2, pady=5, sticky='WE')
