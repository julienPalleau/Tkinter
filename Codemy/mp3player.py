...
def play_time():
    ...
    song = f"C:\\Users\\MOTTIER LUCIE\\Documents\\GitHub\Tkinter\\Codemy\\audio\\{song}.mp3"
...
def add_song():
    song = filedialog.askopenfilename(initialdir=r'audio/', title="Choose A Song", filetypes=(("mp3 Files", "*.mp3"),))
    # Strip out directory structure and .mp3 from song title
    song = song.replace("C:/Users/MOTTIER LUCIE/Documents/GitHub/Tkinter/Codemy/audio/", "")
...
def add_many_songs():
    songs = filedialog.askopenfilenames(initialdir=r'audio/', title="Choose A Song",
                                        filetypes=(("mp3 Files", "*.mp3"),))

    # Loop trhough song list and replace directory structure from song name
    for song in songs:
        # Strip out directory structure and .mp3 from song title
        song = song.replace("C:/Users/MOTTIER LUCIE/Documents/GitHub/Tkinter/Codemy/audio/", "")
        song = song.replace(".mp3", "")
...
def next_song():
    ...
    next_one = playlist_box.curselection()  # next one will be a tuple
    if next_one:
        # Add One To The Current Song Numbler Tuple
...
def previous_song():
    ...
    # Get current song number
    previous_one = playlist_box.curselection()  # next one will be a tuple
...
# Create Slide Function For Song Positionning
def slide(x):
    song = playlist_box.get(ACTIVE)
    if song:
        song = f"C:\\Users\\MOTTIER LUCIE\\Documents\\GitHub\Tkinter\\Codemy\\audio\\{song}.mp3"
...
back_btn_img = PhotoImage(file=r'images/back50.png')
forward_btn_img = PhotoImage(file=r'images/forward50.png')
play_btn_img = PhotoImage(file=r'images/play50.png')
pause_btn_img = PhotoImage(file=r'images/pause50.png')
stop_btn_img = PhotoImage(file=r'images/stop50.png')
