# ----------------------------------------------------------------------------------------------------------------------#
# --------------------------------- Part 2 Flashcard App --------------------------------------------------------------#
# ----------------------------------------------------------------------------------------------------------------------#

# -------------------------
# 1 - Flashcard App Intro -
# -------------------------
from tkinter import *
...
def divide_correct(num1, num2):
    ...
    output_answer_incorrect.set(
        "Incorrect " + str(num1) + " / " + str(num2) + " = " + str(correct) + ", Not " + divide_answer.get())
...
def multiply_correct(num1, num2):
    ...
    output_answer_correct.set("Correct " + str(num1) + " * " + str(num2) + " = " + str(correct))
    output_answer_incorrect.set(
        "Incorrect " + str(num1) + " * " + str(num2) + " = " + str(correct) + ", Not " + multiply_answer.get())
    ...
    multiply_flash.config(text=str(num_1.get()) + " * " + str(num_2.get()), font=("helvetica", 32))
...
def multiply():
    ...
    multiply_flash = Label(multiply_frame, text=str(num_1.get()) + " * " + str(num_2.get()), font=("helvetica", 32))
...
def subtract_correct(num1, num2):
    ...
    output_answer_correct.set("Correct " + str(num1) + " - " + str(num2) + " = " + str(correct))
    output_answer_incorrect.set(
        "Incorrect " + str(num1) + " - " + str(num2) + " = " + str(correct) + ", Not " + subtract_answer.get())
    ...
    num_1.set(randint(0, 10))
    num_2.set(randint(0, 10))
    subtract_flash.config(text=str(num_1.get()) + " - " + str(num_2.get()), font=("helvetica", 32))


# Create our subtraction function
def subtract():
    hide_menu_frames()
    ...
    subtract_flash = Label(subtract_frame, text=str(num_1.get()) + " - " + str(num_2.get()), font=("helvetica", 32))
...
def add_correct(num1, num2):
    ...
    output_answer_correct.set("Correct " + str(num1) + " + " + str(num2) + " = " + str(correct))
    output_answer_incorrect.set(
        "Incorrect " + str(num1) + " + " + str(num2) + " = " + str(correct) + ", Not " + add_answer.get())
...
def home():
    ...
    Label(start_frame, text="Welcome To Math Flashcards!", font=("Helvetica", 18)).pack(pady=40)

    # button to flashcards
    Button(start_frame, text="Addition Flashcards", command=add).pack(pady=5)
    Button(start_frame, text="Subtraction Flashcards", command=subtract).pack(pady=5)
    Button(start_frame, text="Multiplication Flashcards", command=multiply).pack(pady=5)
    Button(start_frame, text="Division Flashcards", command=divide).pack(pady=5)
