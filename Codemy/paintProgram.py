...
# Bind The Mouse To The Canevas
# root = Tk()
# root.title('Paint')
# root.geometry("800x800")
#
#
# def paint(e):  # e stand for event
...
# my_canvas.create_line(150, 0, 150, 200, fill="red")
#
# my_canvas.bind('<B3-Motion>', paint)  # B1 is the left one, B3 is the right one and B2 is the one in the middle
#
# root.mainloop()
...
def paint(e):  # e stand for event
    ...
    # Brush parameters
    brush_width = '%0.0f' % float(my_slider.get())  # % is for substitution
    # brush_color = "green"
...
# Save Image
def save_as_png():
    result = filedialog.asksaveasfilename(initialdir=r'C:\Users\MOTTIER LUCIE\Documents\GitHub\Tkinter\Codemy\images',
...
my_canvas.bind('<B3-Motion>', paint)
