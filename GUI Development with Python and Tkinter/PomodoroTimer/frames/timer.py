...
class Timer(ttk.Frame):
    def __init__(self, parent, controller, show_settings):
        ...
        button_container.grid(column=0, row=2, columnspan=2, sticky="EW")
        ...
        self.start_button.grid(column=0, row=0, sticky="EW")
        ...
        self.stop_button.grid(column=1, row=0, sticky="EW", padx=5)
