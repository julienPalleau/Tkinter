...
class Snake(tk.Canvas):
    ...
    def create_objects(self):
        ...
        # *self.food_position destructured self.food_position so it is the same as self.food_position[0], self.food_position[1]
    ...
    def on_key_press(self, e):
        ...
        if (
                new_direction in all_directions and {new_direction, self.direction} not in opposites
        ):
